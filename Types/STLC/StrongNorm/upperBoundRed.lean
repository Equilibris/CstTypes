...
import Types.STLC.StrongNorm.TyArr
...
theorem upperBoundRed_eq_replace
  ...
  | .abs ty body => by
    ...
    dsimp only [←List.cons_append] at h hRepl
...
/--
info: 'STLC.upperBoundRed_eq_replace' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
-/
#guard_msgs in
#print axioms upperBoundRed_eq_replace
